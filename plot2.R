...
##Saving plot as png
png(filename="C:/Users/pjodh/Desktop/DATA SCIENCE/Coursera/Exploratory_data_analysis/exdata_data_household_power_consumption/plot2.png", width = 480, height = 480)
plot2 <- plot(df$DateTime,df$Global_active_power,type="l",ylab = "Global Active Power (kilowatts)",xlab="")
dev.off()
