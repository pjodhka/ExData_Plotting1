...
##Saving plot as png
png(filename="C:/Users/pjodh/Desktop/DATA SCIENCE/Coursera/Exploratory_data_analysis/exdata_data_household_power_consumption/plot4.png", width = 480, height = 480)
